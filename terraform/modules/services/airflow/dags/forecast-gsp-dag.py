...
# not running PVnet 1 in second half of the hour, as it fails.
with DAG('gsp-forecast-pvnet-1', schedule_interval="5,15,30, * * * *", default_args=default_args, concurrency=10, max_active_tasks=10) as dag:
